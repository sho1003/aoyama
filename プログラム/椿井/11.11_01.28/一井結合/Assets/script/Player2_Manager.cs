...
public class Player2_Manager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //初めの座標位置を指定
        pos[0] = new Vector3(10.0f, 0.6f, 13.0f);
        pos[1] = new Vector3(5.0f, 0.6f, 13.0f);
        pos[2] = new Vector3(0.0f, 0.6f, 13.0f);
        pos[3] = new Vector3(-5.0f, 0.6f, 13.0f);
        pos[4] = new Vector3(-10.0f, 0.6f, 13.0f);
        pos[5] = new Vector3(5.0f, 0.6f, 9.0f);
        pos[6] = new Vector3(-5.0f, 0.6f, 9.0f);
